...
TEST_CSV = os.path.join(os.path.dirname(PACKAGE_DIR), 'data/train_sample.csv')
...
TEST_INPUT = dict(zip(TEST_INPUT_KEYS, TEST_INPUT_VALUES.split('\t')[1:]))
